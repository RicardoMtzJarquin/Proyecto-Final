...
void CFiguras::skybox2 (float altura, float largo, float profundidad, GLuint text1, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prisma2 (float altura, float largo, float profundidad,GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
				{0.5 * largo ,-0.5 * altura , 0.5 * profundidad} ,    //Coordenadas Vértice 0 V0
				{-0.5 * largo,-0.5 * altura, 0.5 * profundidad },    //Coordenadas Vértice 1 V1
				{-0.5 * largo ,-0.5 * altura, -0.5 * profundidad },    //Coordenadas Vértice 2 V2
				{0.5 * largo ,-0.5 * altura, -0.5 * profundidad },    //Coordenadas Vértice 3 V3
				{0.5 * largo ,0.5 * altura, 0.5 * profundidad },    //Coordenadas Vértice 4 V4

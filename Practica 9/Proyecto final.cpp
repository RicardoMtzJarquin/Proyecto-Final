...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	prisma.prisma(3.5, 0.2, 0.2, 0.0);//cama cabezera
	glEnable(GL_LIGHTING);
	...
	prisma.prisma(7.5, 0.2, 0.2, 0.0);//cama cabezera
	glEnable(GL_LIGHTING);
	glPopMatrix();
	...
	prisma.prisma(0.2, 5.5, 0.2, 0.0);//cama cabezera
	glEnable(GL_LIGHTING);
	glPopMatrix();
	...
	glColor3f(0.8, 0.8, 0.8);
	glTranslatef(-0.5, -1.8, 0.0);
	prisma.prisma(0.2, 5.2, 0.2, 0.0);//cama cabezera
	glEnable(GL_LIGHTING);
	glPopMatrix();
	...
	prisma.prisma(3.0, 0.2, 0.2, 0.0);//cama cabezera
	glEnable(GL_LIGHTING);
	glPopMatrix();
	...
	prisma.prisma(0.2, 0.2, 8.2, 0.0);//cama cabezera
	glEnable(GL_LIGHTING);
	glPopMatrix();

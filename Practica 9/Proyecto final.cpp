		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glPushMatrix();
					...
					glRotatef(180, 0, 1, 0);          //llanta delantera izquierda
					glRotatef(girollanta, 1, 0, 0);
					llanta.GLrender(NULL,_SHADED,1.0);
				glPopMatrix();

				glPushMatrix();
					glTranslatef(-6, -1, 7.5);    //llanta delantera derecha
					glRotatef(girollanta, 1, 0, 0);
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();

				glPushMatrix();
					glTranslatef(-6, -1, -9.5);    //llanta trasera izquierda
					glRotatef(girollanta, 1, 0, 0);
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();

				glPushMatrix();
					glTranslatef(6, -1, -9.5);    //llanta trasera derecha
					glRotatef(180, 0, 1, 0);
					glRotatef(girollanta, 1, 0, 0);
					llanta.GLrender(NULL, _SHADED, 1.0);
				glPopMatrix();
			...
			glPushMatrix();
				...
				glRotatef(90, 0, 1, 0);
				glTranslatef(0.0, 1.0, movKit);
				shelby.GLrender(NULL, _SHADED, 1.0);
				glEnable(GL_COLOR_MATERIAL);
			glPopMatrix();
